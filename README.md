...
### MongoDB Community `8.0.17`

- CentOS Stream 9
- Debian 12
- Ubuntu 22.04 & 24.04

### MongoDB Community `7.0.28`
...
| ------------------------------------------ | ---------- | --------------------------------------------------------------------------------------------------------- | --------- |
| mongodb_version                            | `7.0.28`   | MongoDB Community stable releases `v4.4`, `v5`, `v6`, `v7`, `v8`                                          | No        |
